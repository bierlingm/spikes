...
- **`/public/*`** — no bearer token, origin-allowlisted like `POST /spikes`: `GET /public/spikes?project&url`, `GET /public/versions?project`, `GET /public/questions?project`, `POST /public/questions/:id/answers`. Read by the widget.
